...
class LoadModelDemo {
  ...
  _Initialize() {
    ...
    const texture = loader.load([
        './resources/back/px.png',
        './resources/back/nx.png',
        './resources/back/py.png',
        './resources/back/ny.png',
        './resources/back/pz.png',
        './resources/back/nz.png',
    ]);
  ...
  _LoadAnimatedModel() {
    ...
    loader.setPath('./resources/basic/');
